...
public class Browser {
    ...
    private String browserType; //chrome, safari, edge, etc...

    public static String operatingSystem; //windows, androids, IOs, etc...
    ...
    public static String getOSName(){ // we made read only field which is OS
