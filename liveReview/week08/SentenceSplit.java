...
public class SentenceSplit {
    public static void main(String[] args) {
        ...
        System.out.println("searchAmount = " + searchAmount); //searchAmount = 829
      ...
      /*  String[] each2 = confirmation.split(" ");
        ...
        String searchAmount2 = each2[2];
        System.out.println("searchAmount2 = " + searchAmount2);
*/
        String amount = confirmation.split("\n")[1].split(" ")[1]; //chained the string commands
