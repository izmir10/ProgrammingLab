...
public class SuperManTest {
    public static void main(String[] args) {
        ...
        ( (Worker)superManOne ).work("Engineer"); // Down-casting (Explicit casting) ==> from Father class to Worker Interface
        ((Worker) superManOne).getPaid();

        ((Parent)superManTwo).raiseKid();  // Down-casting (Explicit casting) ==> from Father class to Parent Class
