...
public class ArraysUtility {
    ...
    //return the max number from the integer array
...
*/
    ...
    //return the max number from the double array
    public static double max(double[] numbers) {
        Arrays.sort(numbers);
        return numbers[numbers.length - 1];
    }

    //return the min number from the integer array
    public static int min(int[] numbers) {
        Arrays.sort(numbers);
        return numbers[0];
    }

    //return the min number from the double array
    ...
    //check if the given double is contained in the given array. return boolean. contains(double[], double)
    ...
    //check if the given char is contained in the given array. return boolean. contains(char[], char)
    ...
    //check if the given String is contained in the given array. return boolean. contains(String[], String)
    ...
    //adds the given double element to array, returns a new double array
    ...
    //adds the given String element to array, returns a new String array
    ...
    //adds the given char element to array, returns a new char array
    ...
    //removes the index from the array, returns new int array
    public static int[] removeElement(int[] array, int index) {

        if (index < 0 || index > array.length - 1) {  //if the index number is invalid
    ...
    //replaces element of the int array at a given index with the new element
    ...
    //replaces element of the double array at a given index with the new element
    ...
    //replaces element of the char array at a given index with the new element
    ...
    //replaces element of the String array at a given index with the new element
