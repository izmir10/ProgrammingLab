...
public class PolymorphismPractice2 {
    public static void main(String[] args) {
        ...
        for (Employee eachEmployee : employees) {
            if (eachEmployee.getSalary() > employeeWithHighestSalary.getSalary()){
                employeeWithHighestSalary = eachEmployee;
            }
        }
        ...
        out.println("employeeWithHighestSalary = " + employeeWithHighestSalary);
        out.println("testerWithMaxSalary = " + testerWithMaxSalary);
        out.println("developerWithMaxSalary = " + developerWithMaxSalary);
