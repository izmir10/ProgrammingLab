...
public class RemoveElements1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("numbers = " + Arrays.toString(numbers)); //numbers = [100, 300, 400, 500, 600]

        numbers = removeElement(numbers, 1);
        System.out.println("numbers = " + Arrays.toString(numbers)); //numbers = [100, 400, 500, 600]
